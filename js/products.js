let products = [
  ...
  // get added product from session
if (sessionStorage['my_product']) {

  let my_product = JSON.parse(sessionStorage.getItem("my_product"));
  ...
  // localStorage.setItem("new_add", JSON.stringify(newProducts));
  localStorage.setItem("test", JSON.stringify(products));
  sessionStorage.clear();
}

// view products into the page
...
if (localStorage.getItem("test") === null){
  ...
  products_parsed = JSON.parse(localStorage.getItem("test"));
  products_parsed.map(addProduct);
}
...
function addProduct(item){
  ...
  product.innerHTML += ` <div class="card p-3 shadow">
  <div class="row" id="deleteRow">
      <div class="col-12 col-md-3">
          <img src="${item.image}" alt="" style="max-width: 16rem; padding-left: 10px;">
      </div>
      ...
      <div class="col-12 col-md-3 d-flex flex-column">
          ...
          <div class="d-grid gap-2 pt-3" id="${item.price}">
              <button class="btn btn-primary bg-purple" type="button">Deatils</button>
              <button class="btn btn-primary bg-pink delete" id="delete" type="button">Delete</button>
            </div>
      </div>
  </div>
</div><br>`;
...
function clickHandler(e){
  ...
  if (target.className.match("delete")) {  
    ...
    let remo = Number(target.parentElement.id);
    let productsg = products.filter(x => x.price !== remo)
